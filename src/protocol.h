...
static ServiceFlags GetDesirableServiceFlags(ServiceFlags services) {
    //cmcTODO - reenable NODE_WITNESS flag in future releases once majority of clients support this
...
/** cpuminerscoin: How much temperature a PoW header will remove */
