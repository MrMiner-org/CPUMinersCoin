...
const char * const BITCOIN_CONF_FILENAME = "cpuminerscoin.conf";
const char * const BITCOIN_PID_FILENAME = "cpuminerscoind.pid";
...
#else
    const char* pszModule = "cpuminerscoin";
#endif
    if (pex)
        return strprintf(
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CMC";
#else
    // Unix
    return pathRet / ".cpuminerscoin";
#endif
#endif
}
