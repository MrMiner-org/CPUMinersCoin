...
// cpuminerscoin: optional setting to unlock wallet for block staking only;
...
//    return n ? n : nTimeReceived;
    ...
    // cpuminerscoin: we still have the timestamp, so use it to avoid confusion
    return tx->nTime;
}
...
// cpuminerscoin: total coins staked (non-spendable until maturity)
...

    {
        ...
        for (const auto& entry : mapWallet)
        {
            ...
            if (nSpendTime > 0 && pcoin->tx->nTime > nSpendTime)
                continue;  // cpuminerscoin: timestamp must not exceed spend time
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    txNew.nTime = wtxNew.tx->nTime;  // cpuminerscoin: set time
...
//                }
                ...
                // cpuminerscoin: sub-cent change is moved to fee
...
//cmcTODO: this code was in 0.7, but was refactored by b33d1f5ee512da5719b793b3867f75f1eea5cf52:
//                int64 nPayFee;
//                if (fNewFees)
...
//                    nPayFee = nTransactionFee * (1 + (int64)nBytes / 1000);
                ...
                if (nFeeRet >= nFeeNeeded) {
                    ...
                    if (nChangePosInOut == -1 && nSubtractFeeFromAmount == 0 && pick_new_inputs) {
                        ...
                        CAmount minimum_value_for_change = MIN_TXOUT_AMOUNT;  //cmcTODO - is this correct?
...
// cpuminerscoin: create coin stake transaction
