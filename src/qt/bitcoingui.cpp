...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CMC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cpuminerscoin: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CMC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CMC addresses"));
    ...
    openAction->setStatusTip(tr("Open a cpuminerscoin: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CMC command-line options").arg(tr(PACKAGE_NAME)));

    //openChatroomAction = new QAction(QIcon(":/icons/cpuminerscoin"), tr("&Chatroom"), this);
    //openChatroomAction->setStatusTip(tr("Open the CMC Discord in a web browser."));

    //openForumAction = new QAction(QIcon(":/icons/cpuminerscoin"), tr("&Forum"), this);
    //openForumAction->setStatusTip(tr("Open https://talk.cpuminerscoin.net in a web browser."));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to CMC network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("CMC"); // default title
